...
function autocomplete(input, latInput, lngInput) {
    ...
    // if someone hits enter the address field, don't submit the form
    ...
    _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
        ...
        markers.forEach(function (marker) {
            return marker.addListener('click', function () {
                // proper function to access this
...
// Used to avoid injection attacks
...
function typeAhead(search) {
    ...
    searchInput.on('keyup', function (e) {
        ...
        if (e.keyCode === 40 && current) {
            ...
            // if they press down and there isn't one currently selected
            next = items[0];
...
function ajaxHeart(e) {
    ...
    _axios2.default.post(this.action).then(function (res) {
        var isHearted = _this.heart.classList.toggle('heart__button--hearted'); // in forms, you can access tags by their name with dot notation
